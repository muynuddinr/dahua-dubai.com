...
const solutionCategories = [
    {
        ...
        image: '/building/Building Security.jpg',
    },
    {
        ...
        image: '/building/Key Technology.jpg',
    },
    {
        ...
        image: '/building/System Structure.jpg',
    },
]
...
const BuildingSolutionPage = () => {
    ...
    const mobileBannerData = {
        image: "/mobile/building.jpg",
        title: "Building Security Solutions",
        subtitle: "Smart Building Protection",
        description:
            "Comprehensive security for residential and commercial buildings with integrated surveillance and access control.",
    }
    ...
    return (
        <div className="min-h-screen bg-white overflow-x-hidden overflow-y-auto">
            ...
            >
                ...
                >
                    <Image
                        src="/images/Building security banner.jpg"
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center">
                    <div className="max-w-4xl px-10 space-y-6">
                        ...
                        >
                            <span className="block text-5xl text-white">Building</span>
                    ...
                    >
                        <motion.div className="text-center mb-8 md:mb-12 overflow-hidden" variants={shouldReduceMotion ? reducedMotionVariants : fadeInUp}>
                            ...
                            <p className="text-lg md:text-xl text-gray-600">
                                Comprehensive security and monitoring solutions for residential and commercial buildings
                            </p>
                        </motion.div>
