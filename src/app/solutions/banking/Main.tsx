...
const IndustryPage = () => {
  ...
  const mobileBannerData = {
    ...
    subtitle: "Financial Institution Protection",
    description:
      "Trusted by financial institutions, our advanced banking security solutions combine AI-powered analytics, 24/7 surveillance, and seamless integration.",
  }
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center">
          <div className="max-w-4xl px-10 space-y-6">
            ...
            >
              <span className="block text-5xl text-white">Banking</span>
              <span className="block text-5xl text-red-500">
                Security Solutions
              </span>
            </motion.h1>
            <motion.p
            ...
            >
              Trusted by financial institutions, our advanced banking security
              solutions combine AI-powered analytics, 24/7 surveillance, and
              seamless integration—protecting assets, customers, and operations
            ...
            >
              {[
                ...
                },
                {
                  ...
                  description:
                    "Banking-specific security solutions designed for financial institutions",
                  color: "bg-gray-600",
                },
                {
                  icon: Cpu,
                  ...
                  description:
                    "Advanced analytics for transaction security and customer protection",
                  color: "bg-red-600",
                },
              ].map((benefit, index) => {
          ...
          >
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-600">
                Comprehensive security and monitoring solutions for banking and
