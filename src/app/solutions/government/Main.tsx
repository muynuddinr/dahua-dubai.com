...
const GovernmentSolutionPage = () => {
    ...
    const mobileBannerData = {
        image: "/mobile/government.jpg",
        title: "Government Security Solutions",
        subtitle: "Public Sector Protection",
        description:
            "Protect cities, borders, and critical infrastructure with AI-powered surveillance and centralized management.",
    }
            ...
            >
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center">
                    <div className="max-w-4xl px-10 space-y-6">
                        ...
                        >
                            <span className="block text-5xl text-white">Government</span>
