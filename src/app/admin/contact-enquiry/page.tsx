  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">Manage general contact form submissions</p>
      </div>
            ...
            <>
              <div className="p-6 border-b border-gray-800">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-gray-400">{selectedEnquiry.subject || 'No subject'}</p>
                  </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex gap-3">
                  <a
                    href={`mailto:${selectedEnquiry.email}?subject=Re: ${selectedEnquiry.subject || 'Your Enquiry'}`}
                  ...
                  <a
                    ...
                    className="px-4 py-3 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 rounded-xl font-medium transition-colors flex items-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
